...
/* 
each user has its own socketID so at start its null,
So using socketio instance to start a new connection
for user, and storing his ID in  socketID  variable
*/
...
/*
Port 4200 is started to listen to our http requests,
and connecting database by adding db path and 
returning name of our BD using middleware
*/

/*
Once i get connected with database ,
I can easily define my app functionalities inside it 
and use them
*/
...
http.listen(3000, function () {
	...
	mongoClient.connect("mongodb://localhost:27017", function (error, client) 
 	{
		var database = client.db("MuslimBook");
		console.log("Database connected.");

		/*sending rendered .html file 
		as string to Client (4200/signup)*/

		app.get("/signup", function (request, result) {
			result.render("signup"); 
		});

		//get data from signup form and creates data in Server DB
		app.post("/signup", function (request, result) 
		{
			...
			//findOne returns whole user document that matches filter ($or:)
